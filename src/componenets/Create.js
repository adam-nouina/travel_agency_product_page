...
export default function Create() {
    const { onChange, onChange2, storeElement, errors, getCitys, citys } = useContext(ElementsContext)
        ...
        <div className='container mt-5'>
            <form onSubmit={storeElement}>
                ...
                <div className="form-group">
                    ...
                    <input name="description" onChange={onChange} type="text" className="form-control" />
                ...
                <div className="form-group">
                    <label>Rooms</label>
                    <input name="rooms" onChange={onChange} type="number" className="form-control" />
                    {errors.price && <span className='text-danger'>{errors.rooms[0]}</span>}
                </div>
                <div>
                    <label>Citys</label>
                    <select onChange={onChange} className="form-select" aria-label="Default select example" name="city_id">
